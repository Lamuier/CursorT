...
- Five tabs—Overview, Usage, Billing, Tasks, Status—with animated switching. Tab order is customizable in Settings. Overview shows two rings for own-pool and third-party model usage, with billing-cycle progress under the rings.
